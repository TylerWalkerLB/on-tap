...
function ontapAdmin() {
    ...
    add_menu_page('On Tap','On Tap','manage_options','on-tap/on-tap.php','','dashicons-exerpt-view',33);
    add_submenu_page('on-tap/ontap.php','on-tap/ontap.php','Options', 'manage_options','on-tap/on-tap-admin.php');
}
